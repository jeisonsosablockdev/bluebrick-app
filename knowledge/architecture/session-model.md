...
type: Spec
title: Session Model
description: Comprehensive session model for BRIDS — hybrid WorkOS + SIWS, cookie strategy, lifecycle, authorization layers, route matrix, security notes, and feature-specific boundary confirmations
tags: [architecture, session, auth, siws, workos, hybrid, rbac, cookies, security, trust-boundaries]
timestamp: 2026-06-16T00:00:00Z
resource: https://github.com/jeisonsosablockdev/brids/blob/develop/docs/session-model.md
---
