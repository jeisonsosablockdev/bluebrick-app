...
type: Spec
title: NFT Spec
description: Complete NFT specification for BRIDS — admin Candy Machine deploy, marketplace purchase flow, mint authority, metadata ownership, economic AppData, delegate lifecycle, royalty model, collection validation, snapshot persistence, and devnet proofs
tags: [architecture, nft, metaplex-core, candy-machine, marketplace, purchase, authority, appdata, delegate, royalty, devnet]
timestamp: 2026-06-16T00:00:00Z
resource: https://github.com/jeisonsosablockdev/brids/blob/develop/docs/nft-spec.md
---
