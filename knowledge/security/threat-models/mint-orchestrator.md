---
type: Threat Model
title: Mint Orchestrator Threat Model
description: P0-06 mint orchestration attack vectors and mitigations — idempotency, webhook replay, admin authority, DAS reconciliation
tags: [security, threat-model, mint, orchestrator, idempotency, webhook, das, admin, solana]
timestamp: 2026-06-16T00:00:00Z
resource: https://github.com/jeisonsosablockdev/brids/blob/develop/docs/threat-model.md
---

# Mint Orchestrator Threat Model
