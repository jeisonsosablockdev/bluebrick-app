...
| Marketplace payload derivation (`deriveNftPriceUsd`, knowledge/highlights builders) | pure helpers in legacy file | keep pure in dedicated helper module | Wrong business payload and failed submissions |
