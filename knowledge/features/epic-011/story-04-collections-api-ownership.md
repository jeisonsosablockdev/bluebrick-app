---
type: Feature Spec
title: EPIC-011 STORY-011-04 Collections API Ownership
description: API foundation for collection detail routes — ownership validation helper, GET/PATCH endpoints, centralized payload validation, and repository delegation
tags: [feature, epic-011, story-011-04, collections, api, ownership, marketplace, admin, bri-94]
