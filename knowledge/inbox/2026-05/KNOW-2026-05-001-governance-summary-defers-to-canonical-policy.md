...
source_feature: knowledge/features/feature-shared-knowledge-promotion-system-bri-143.md
...
- Canonical docs and enforcement already existed in `knowledge/governance/documentation-policy.md` and `scripts/ci/check-required-docs.sh`.
