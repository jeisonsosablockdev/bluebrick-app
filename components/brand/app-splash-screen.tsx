...
export function AppSplashScreen() {
  ...
  // Drift and breathing animations for the radial glow lights
  const cyanVariants = {
  ...
  const letterVariants = (index: number) => {
    let fadeDuration = 0.16;
    let fadeDelay = index * 0.05;
  ...
  const wordmarkVariants = {
    ...
    collapsed: {
      ...
      transition: {
        duration: 0.7,
        ease: [0.25, 1, 0.5, 1] as [number, number, number, number] // easeOutQuart (matches B-Mark)
      }
    },
    exiting: {
      x: -70,
        ...
        >
          <defs>
            ...
            <linearGradient id="linear-gradient-logo" x1="-3.94" y1="7750.69" x2="-2.94" y2="7750.69" gradientTransform="translate(-289946.98 140.09) rotate(90) scale(37.41 -37.41)" gradientUnits="userSpaceOnUse">
              ...
              <stop offset=".17" stop-color="#03aff9"/>
              <stop offset=".31" stop-color="#0dadf9"/>
              <stop offset=".44" stop-color="#1ea9f9"/>
              <stop offset=".57" stop-color="#37a4f9"/>
              <stop offset=".69" stop-color="#569df9"/>
              <stop offset=".81" stop-color="#7d95f9"/>
              <stop offset=".92" stop-color="#a98bf9"/>
              <stop offset="1" stop-color="#cf84f9"/>
              <stop offset="1" stop-color="#cf84f9"/>
            </linearGradient>
          </defs>
          <motion.g
          ...
          <motion.g
            ...
            initial="initial"
            animate={phase}
            style={{ transformOrigin: "10.5px 19.25px" }}
          >
