          ...
          <div className="space-y-2">
            {pins.map((pin) => (
              <button
                ...
                className={`block w-full rounded-xl border px-2.5 py-2 text-left transition hover:border-cyan-300/40 hover:bg-slate-950/85 ${
              ...
              >
                <div className="flex items-start justify-between gap-2">
                  ...
                  <span className="rounded-full border border-cyan-300/20 bg-cyan-300/10 px-1.5 py-0.5 text-[10px] font-semibold text-cyan-100">
