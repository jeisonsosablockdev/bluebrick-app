...
export function AccountProfileSupportModule({ email }: AccountProfileSupportModuleProps): ReactElement {
  ...
  return (
    <div className="fixed inset-0 z-40 flex items-center justify-center bg-slate-950/76 p-4 backdrop-blur-md sm:p-6">
      <Card className="relative max-h-[90vh] w-full max-w-2xl overflow-y-auto border-white/12 bg-[linear-gradient(180deg,rgba(14,21,37,0.94),rgba(8,12,24,0.98))] p-0 shadow-[0_30px_90px_rgba(5,10,20,0.45)]">
        ...
        <div className="relative z-10 flex items-start justify-between gap-4 border-b border-white/10 px-5 pb-4 pt-5 sm:px-6 sm:pb-5 sm:pt-6">
          <div className="space-y-2">
            ...
            <h2 className="max-w-[18ch] text-[1.7rem] font-semibold leading-[1.06] text-white sm:text-[1.95rem]">
              {t({
