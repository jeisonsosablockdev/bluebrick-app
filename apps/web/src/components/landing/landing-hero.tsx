...
/**
 * Official SVG path for the "Blue Brick" wordmark extracted from canonical brand assets.
 */
const BLUE_BRICK_WORDMARK_PATH =
...
export function LandingHero(): React.JSX.Element {
  ...
  // Step 2: Render top brand header with official lockup (emblem + aligned text column), greeting, and subtitle
  return (
    <header style={{ display: "flex", width: "100%", flexDirection: "column", alignItems: "center", textAlign: "center" }}>
      {/* Brand Lockup: Emblem on left, Wordmark and Tagline directly underneath on right */}
      <div
        style={{
          display: "inline-flex",
          alignItems: "center",
      ...
      >
        <Image
          src={isDark ? "/brand/bluebrick-mark-white.svg" : "/brand/bluebrick-mark-dark.svg"}
          alt="Blue Brick Emblem"
          width={36}
          height={38}
          priority
          unoptimized
        ...
        />
        <div style={{ display: "flex", flexDirection: "column", width: 172 }}>
          {/* Blue Brick Vector Wordmark */}
          <svg
            viewBox="190 22 702 108"
            style={{ height: 27, width: 172, display: "block" }}
            aria-label="Blue Brick"
          >
            <path
              d={BLUE_BRICK_WORDMARK_PATH}
              fill={isDark ? "#FFFFFF" : "#04283C"}
              fillRule="evenodd"
            />
          </svg>
          <span
          ...
          {/* Tagline positioned directly and exclusively beneath Blue Brick, occupying its exact width */}
          <span
            style={{
              marginTop: 3,
              fontSize: 13.5,
      ...
      >
        {t("landing.greetingHeadline")}
      </h1>

      {/* Direct Portfolio Access Subtitle */}
      <p
        style={{
          marginTop: 8,
          maxWidth: 540,
      ...
      >
        {t("landing.portfolioAccessSubtitle")}
      </p>
    </header>
  );
}
