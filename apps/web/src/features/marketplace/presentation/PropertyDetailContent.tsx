...
import { PropertyDetailHeroSection } from "@/features/marketplace/presentation/PropertyDetailHeroSection";
...
export function PropertyDetailContent({ property, imageClassName = "h-64 md:h-80", layoutId }: PropertyDetailContentProps) {
  ...
  const hasProjectMedia = (property.galleryImages?.length ?? 0) > 0 || (property.propertyImages?.length ?? 0) > 0;
