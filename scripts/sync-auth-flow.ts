#!/usr/bin/env node
/**
 * Sync knowledge/auth-flow.md to knowledge/architecture/auth-flow.md with OKF frontmatter
 */

import { readFileSync, writeFileSync } from 'fs';

const source = 'knowledge/auth-flow.md';
...
resource: https://github.com/jeisonsosablockdev/brids/blob/develop/knowledge/auth-flow.md
---
