...
| --- | --- | --- | --- |
| 1 | `planner` | Detect frontend scope and activate this workflow | Routes, UI surfaces, motion intent, evidence needs, and any required artifact/slice model are identified |
...
| 4 | `docs` | Confirm artifact prerequisites and sync required docs for non-trivial work | Implementation does not run ahead of the governing artifact, and motion/tooling language is captured in the slice plan |
...
- Motion 12 tooling notes, current syntax references, and any OpenAI Developers tooling references used for the UX/UI slice
