...
| STORY-011-09 | Google Maps location integration | `STORY-011-09-google-maps-location-integration.md` | `approved` | `TBD` | Address autocomplete, maps persistence, and outbound maps UX; `BRI-110` closes current address display + outbound CTA and `BRI-111` closes the dedicated backend location/maps contract |
