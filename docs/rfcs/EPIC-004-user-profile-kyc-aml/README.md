...
- [ ] Sistema ejecuta screening AML de wallet con Helius y persiste solo resultados de riesgo (`aml_status`, `aml_risk_score`, flags).
...
| STORY-004-04 | Integracion Helius: Screening AML de Wallet | `STORY-004-04-helius-aml-wallet-screening.md` | `approved` | `TBD` | Riesgo AML y proyeccion a compliance status |
