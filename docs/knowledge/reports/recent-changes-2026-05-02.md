...
Base Branch: develop
Current Branch: feature/shared-knowledge-promotion-system
Merge Base: 8e17d7d63bea1d2f65f8d0de5eaf20d4ccf857c0

## Commits

- No branch commits yet.
...
- `scripts/knowledge/knowledge-core.ts` -> automation: Touches developer-facing commands or automation.
- `scripts/knowledge/recent-changes-core.ts` -> automation: Touches developer-facing commands or automation.
- `scripts/knowledge/scan-recent-changes.ts` -> automation: Touches developer-facing commands or automation.
- `tests/lib/knowledge-system.test.ts` -> code: Touches implementation code or tests.

## Candidate Actions

- Consider an automation candidate if the workflow is reusable across branches.
- Consider a guide candidate if the pattern is reusable outside the current slice.
- Confirm the feature note captures any reusable workflow insight, not just feature behavior.
